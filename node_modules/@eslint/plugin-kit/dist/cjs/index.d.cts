...
export type TextSourceCode<Options extends SourceCodeBaseTypeOptions = $eslintcore.SourceCodeBaseTypeOptions> = import("../../../core/dist/esm/types").TextSourceCode<Options>;
...
export type CustomRuleDefinitionType<LanguageSpecificOptions extends Omit<import("../../../core/dist/esm/types").RuleDefinitionTypeOptions, keyof CustomRuleTypeDefinitions>, Options extends Partial<CustomRuleTypeDefinitions>> = import("./types.cts").CustomRuleDefinitionType<LanguageSpecificOptions, Options>;
...
import type * as $eslintcore from "../../../core/dist/esm/types";
